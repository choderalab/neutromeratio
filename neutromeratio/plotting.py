...
def plot_correlation_analysis(
    ...
    plt.text(-9.0, 18.0, r"Nr of tautomer pairs$ = {}$".format(len(names)), fontsize=fontsize)
    ...
    ax.plot((-10.0, 25.0), (-10.0, 25.0), "k--", zorder=-1, linewidth=1., alpha=0.5)
    ax.plot((-9.0, 25.0), (-10.0, 24.0), "gray", zorder=-1, linewidth=1., alpha=0.5)
    ax.plot((-10.0, 24.0), (-9.0, 25.0), "gray", zorder=-1, linewidth=1., alpha=0.5)
    
    ax.plot((-10.0, 25.0), (0.0, 0.0), "r--", zorder=-1, linewidth=1., alpha=0.5)
    ax.plot((0.0, 0.0), (-10.0, 25.0), "r--", zorder=-1, linewidth=1., alpha=0.5)
