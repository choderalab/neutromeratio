...
def generate_orca_script_for_solvation_free_energy(mol: Chem.Mol, conformer_id: int = 0) -> str:
...
def run_orca(file_path):
    ...
    p = Popen(['/home/mwieder/Work/Software/orca_4_0_1_2_linux_x86-64_openmpi202/orca', file_path], stdin=PIPE, stdout=PIPE, stderr=PIPE)
